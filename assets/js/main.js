...
const additionalStyles = `
    .reading-progress{position:fixed;top:0;left:0;width:0%;height:3px;background-color:var(--primary-color,#fc0);z-index:9999;transition:width .1s ease}
	.current-section{color:var(--primary-color,#fc0)!important;transition:color .3s ease}
	.social-links{display:flex;flex-direction:column;gap:.5rem}
	.social-links a{display:flex;align-items:center;gap:.5rem;opacity:.8}
	.social-links a:hover{opacity:1}
	@media (max-width:768px){
		.mobile-menu-toggle{display:block;background:0 0;border:none;font-size:1.5rem;color:#333;cursor:pointer;padding:.5rem}
		.nav-menu{display:none;position:absolute;top:100%;left:0;right:0;background-color:#fff;flex-direction:column;padding:1rem;box-shadow:0 5px 15px rgba(0,0,0,.1);z-index:1000}
		.nav-menu.active{display:flex}
		.nav-menu a{padding:.75rem 0;border-bottom:1px solid #f0f0f0}
		.nav-menu a:last-child{border-bottom:none}
		body.night .mobile-menu-toggle{color:var(--dark-text,#f5f5f5)}
		body.night .nav-menu{background-color:var(--dark-bg,#252627)}
		body.night .nav-menu a{border-bottom-color:#444}
